...
const translations = {
    en: {
        ...
        "modal-auth-title": "Sign In",
        "modal-auth-desc": "Sign in feature is under preparation. Order details will be sent directly to your registered email address.",
        "modal-auth-btn": "Login Feature Coming Soon",
        "modal-auth-agree": "We are working hard to bring you secure user accounts soon.",
    ...
    ko: {
        ...
        "modal-auth-title": "로그인",
        "modal-auth-desc": "로그인 기능은 준비 중입니다. 주문 확인 내역은 등록하신 이메일로 즉시 발송됩니다.",
        "modal-auth-btn": "로그인 기능 준비 중",
        "modal-auth-agree": "안전하고 신뢰할 수 있는 사용자 계정 서비스를 조속히 제공하겠습니다.",
