...
const currentLang = ((window.DEFAULT_LANG || localStorage.getItem('chinaboost_lang') || navigator.language || 'en').toLowerCase().startsWith('ko')) ? 'ko' : 'en';
...
function applyTranslations(lang) {
  ...
  localStorage.setItem('chinaboost_lang', activeLang);
