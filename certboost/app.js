...
const packageCatalog = {
    iso: {
        title_en: 'ISO 27001 / 27701',
        title_ko: 'ISO 27001 / 27701',
        packages: [
            { id: 'iso-readiness', name_en: 'Readiness Assessment', name_ko: '레디니스 평가', desc_en: 'Scoped gap analysis, control mapping, and auditor handoff pack.', desc_ko: '범위 갭 분석, 통제 매핑 및 감사관 인도 패키지.', price: 880, featured: false, features_en: ['Gap Assessment', 'ROPA Draft', 'SoA Guidance', 'Evidence Pack'], features_ko: ['갭 분석', 'ROPA 초안', 'SoA 작성 가이드', '증거 패키지'] },
            { id: 'iso-standard', name_en: 'Standard Program', name_ko: '표준 프로그램', desc_en: 'Core ISMS implementation for certification body submission.', desc_ko: '인증기관 제출용 핵심 ISMS 구축.', price: 1400, featured: true, features_en: ['ISMS Buildout', 'Statement of Applicability', 'Internal Audit Prep', 'Lead Auditor Support'], features_ko: ['ISMS 구축', '적용성 명세서', '내부 감사 준비', '리드 감사관 지원'] },
    ...
    soc2: {
        title_en: 'SOC 2 Type II Readiness',
...
const translations = {
    en: {
        "logo-subtitle": "CERTBOOST!",
        "nav-home": "Home",
        "nav-iso": "ISO Certification",
        "nav-gdpr": "GDPR Audit",
        ...
        "hero-title": "BibleForAI - CERTBOOST!",
        "hero-desc": "Internationally usable certification consulting for ISO 27001, GDPR, SOC 2, HIPAA, and cross-border compliance across 40+ jurisdictions.",
        ...
        "card-iso-title": "ISO 27001 / 27701",
        "card-iso-desc": "End-to-end ISMS implementation, gap analysis, document preparation, and external auditor readiness.",
        "card-gdpr-title": "GDPR Audit Readiness",
        ...
        "comp-desc": "Our consultants partner with licensed auditors and notifiers to keep your certification journey compliant, auditable, and internationally recognized.",
        "comp-bullet1-bold": "Lead Auditors:",
        "comp-bullet1-text": "Experienced with ISO/IEC 17021 accredited bodies and AICPA reviewers.",
        ...
        "comp-bullet3-text": "Prevent expensive reregistration delays with pre-audit reviews and evidence prep.",
        
        "view-iso-title": "ISO 27001 / 27701 Certification Consulting",
        "view-iso-sub": "Build an auditable ISMS/PMS with scoped controls, risk treatment plans, and Statement of Applicability guidance.",
        "view-gdpr-title": "GDPR Audit Readiness Program",
        ...
        "view-soc2-title": "SOC 2 Type II Readiness",
        "view-soc2-sub": "Trust service criteria mapping, control design, testing workflows, and auditor coordination for Type II readiness.",
        "view-hipaa-title": "HIPAA Privacy & Security Program",
        ...
        "view-cross-title": "Cross-Border Certification Program",
        ...
        "foot-gdpr": "ISO 27001 Ready",
        "foot-canspam": "SOC 2 Capable",
        "foot-match": "96% Pass Rate",
        "foot-contact": "Contact support: certify@bibleforai.com",
        "foot-copy": "&copy; 2026 BibleForAI CERTBOOST. All rights reserved. Global Compliance Certification Consulting.",
        
        "order-button": "Order Package",
        "featured-badge": "Best Seller",
        
        // Receipts
        "receipt-header": "BIBLEFORAI - CERTBOOST RECEIPT",
    ...
    ko: {
        ...
        "hero-title": "BibleForAI - CERTBOOST!",
        "hero-desc": "ISO 27001, GDPR 감사 대비, SOC 2, HIPAA, 글로벌 인증 컨설팅. 40+ 관할 지역 라이선스 컨설턴트 매칭.",
        ...
        "comp-bullet1-text": "ISO/IEC 17021 인정 기구 및 AICPA 검토자와 협업합니다.",
        ...
        "view-iso-title": "ISO 27001 / 27701 인증 컨설팅",
        ...
        "foot-gdpr": "ISO 27001 대응",
        "foot-canspam": "SOC 2 대응",
        "foot-match": "96% 합격률",
        "foot-contact": "문의 지원: certify@bibleforai.com",
        "foot-copy": "&copy; 2026 BibleForAI CERTBOOST. All rights reserved. 글로벌 인증 컨설팅.",
        
        "order-button": "패키지 주문하기",
        "featured-badge": "베스트 셀러",
        
        // Receipts
        "receipt-header": "BIBLEFORAI - CERTBOOST 영수증",
        "receipt-date": "주문 날짜",
...
function applyTranslations() {
    ...
    document.title = lang === 'ko'
        ? "BibleForAI - CERTBOOST | 글로벌 인증 컨설팅"
        : "BibleForAI - CERTBOOST | Global Compliance Certification Consulting";

    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
        metaDesc.content = lang === 'ko'
            ? "ISO 27001, GDPR 감사 대비, SOC 2, HIPAA, 글로벌 인증 컨설팅. 40+ 관할 지역 라이선스 컨설턴트 매칭."
            : "Internationally usable certification consulting for ISO 27001, GDPR, SOC 2 Type II, HIPAA, and cross-border certification across 40+ jurisdictions.";
    }

    ['og:title','twitter:title'].forEach(sel => {
        const el = document.querySelector(`meta[property="${sel}"]`) || document.querySelector(`meta[name="${sel}"]`);
        if (el) el.content = lang === 'ko' ? "BibleForAI - CERTBOOST | 글로벌 인증 컨설팅" : "BibleForAI - CERTBOOST | Global Compliance Certification Consulting";
    });
    ['og:description','twitter:description'].forEach(sel => {
        const el = document.querySelector(`meta[property="${sel}"]`) || document.querySelector(`meta[name="${sel}"]`);
        if (el) el.content = lang === 'ko'
            ? "ISO 27001, GDPR 감사 대비, SOC 2, HIPAA, 글로벌 인증 컨설팅. 40+ 관할 지역 라이선스 컨설턴트 매칭."
            : "ISO 27001, GDPR audit readiness, SOC 2 Type II, HIPAA, and cross-border certification consulting across 40+ jurisdictions.";
    });
...
function saveLocalOrder(details) {
    const orderLogs = JSON.parse(localStorage.getItem('certboost_orders')) || [];
    const selectedCountry = document.getElementById('order-country').value;
    ...
    localStorage.setItem('certboost_orders', JSON.stringify(orderLogs));
    renderOrders();
