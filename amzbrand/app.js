// AMZBRAND app state
const STORAGE_KEY = 'amzbrand_orders';
...
const packageCatalog = {
  amazon: {
    title_en: 'Amazon Brand Registry & Storefront',
    title_ko: '아마존 브랜드 등록 & 스토어프론트',
    packages: [
      {
        id: 'registry-starter',
        name_en: 'STANDARD — Registry Starter',
        name_ko: '스탠다드 — 브랜드 등록 스타터',
        desc_en: 'Brand registry checklist, listing audit, and basic storefront outline for new Amazon brands.',
        desc_ko: '신규 아마존 브랜드를 위한 브랜드 등록 체크리스트, 리스팅 진단, 기본 스토어프론트 기획.',
        price: 189,
        featured: false,
        features_en: [
          'Registry checklist',
      ...
      {
        id: 'storefront-plus',
        name_en: 'DELUXE — Storefront & A+ Content',
        name_ko: '델럭스 — 스토어프론트 & A+ 콘텐츠',
        desc_en: 'Storefront wireframe, A+ content copy, image guidance, and 30-day support.',
        desc_ko: '스토어프론트 와이어프레임, A+ 콘텐츠 카피, 이미지 가이드, 30일 지원 포함.',
        price: 579,
        featured: true,
        features_en: [
      ...
      {
        id: 'brand-protect',
        name_en: 'PREMIUM — Brand Protection & Growth',
        name_ko: '프리미엄 — 브랜드 보호 & 성장',
        desc_en: 'Monitoring, hijacker response, catalog cleanup, and priority strategy for protected growth.',
        desc_ko: '모니터링, 하이재커 대응, 카탈로그 정리, 우선 전략 지원으로 브랜드 성장을 보호합니다.',
        price: 1479,
        featured: false,
        features_en: [
          'Monitoring setup',
...
const translations = {
  en: {
    'logo-subtitle': 'Amazon Brand Operations!',
    'nav-overview': 'Overview',
    'nav-packages': 'Packages',
    'nav-faq': 'FAQ',
    'nav-orders': 'Orders',
    'btn-orders': 'My Orders',
    'hero-badge': 'Global Amazon Brand',
    'hero-title': 'AMZBRAND — Amazon Brand Registry & Storefront',
    'hero-desc': 'Protect your brand, optimize storefronts, and scale Amazon listings with data-backed brand reporting.',
    'hero-cta': 'See Packages',
    'hero-secondary': 'Read FAQ',
    'stat-one-num': 'Registry',
    'stat-one-label': 'Brand setup',
    'stat-two-num': 'Storefront',
    'stat-two-label': 'Visual storefronts',
    'stat-three-num': 'Protected',
    'stat-three-label': 'Brand defense',
    'section-packages-title': 'Amazon Brand Services',
    'section-packages-sub': 'Choose a plan for registry setup, storefront design, A+ content, and protection.',
    'why-title': 'Why AMZBRAND works',
    'why-desc': 'Inspired by our brand-first Amazon operating method: registry setup, storefront planning, A+ content, and brand protection.',
    'why-1-bold': 'Brand-first strategy:',
    ...
    'faq-sub': 'Answers for sellers building or protecting an Amazon brand.',
    'faq-q1': 'What do I need to prepare before starting?',
    'faq-a1': 'Send your marketplace, brand name, and any existing ASINs or storefront links. If you already have a trademark, sharing the filing status helps.',
    ...
    'faq-a3': 'You receive email updates, a structured receipt, and Google Form intake for brand assets and goals.',
    'faq-q4': 'Is this a one-time service or ongoing management?',
    'faq-a4': 'Both. STANDARD is a one-time registry setup package, while DELUXE and PREMIUM are ongoing brand growth plans.',
    ...
    'modal-title': 'Configure Brand Order',
    ...
    'foot-note': 'AMZBRAND helps Amazon sellers improve PPC control, keyword discipline, and account operations.',
    'foot-contact': 'Contact support: snsherocom@gmail.com',
    'foot-copy': '&copy; 2026 BibleForAI AMZBRAND. All rights reserved.',
    'receipt-header': 'BIBLEFORAI - AMZBRAND RECEIPT',
  ...
  ko: {
    ...
    'nav-orders': '주문내역',
    'btn-orders': '내 주문내역',
    'hero-badge': '글로벌 아마존 브랜드',
    'hero-title': 'AMZBRAND — 아마존 브랜드 등록 & 스토어프론트',
    'hero-desc': '브랜드를 보호하고 스토어프론트를 최적화하며, 데이터 기반 브랜드 리포트로 아마존 리스팅을 확장하세요.',
    'hero-cta': '패키지 보기',
    ...
    'section-packages-title': '아마존 브랜드 서비스',
    'section-packages-sub': '브랜드 등록, 스토어프론트 디자인, A+ 콘텐츠, 브랜드 보호 수준에 맞는 플랜을 선택하세요.',
    'why-title': 'AMZBRAND가 효과적인 이유',
    'why-desc': '브랜드 등록, 스토어프론트 기획, A+ 콘텐츠, 브랜드 보호를 기반으로 한 운영 방식입니다.',
    ...
    'faq-a1': '마켓플레이스, 브랜드명, 기존 ASIN 또는 스토어프론트 링크를 보내주세요. 상표가 있다면 출원 상태도 함께 알려주세요.',
    'faq-q2': '어떤 마켓플레이스를 지원하나요?',
    'faq-a2': '미국, 영국, 유럽, 일본, 캐나다를 포함한 글로벌 아마존 마켓플레이스를 지원하며, 요청 시 추가 지역도 협의 가능합니다.',
    'faq-q3': '작업 결과는 어떻게 전달되나요?',
    'faq-a3': '이메일 업데이트, 구조화된 영수증, 그리고 브랜드 자산/목표 입력용 Google Form으로 전달됩니다.',
    'faq-q4': '1회성 서비스인가요, 아니면 운영형 서비스인가요?',
    'faq-a4': '둘 다 가능합니다. STANDARD는 1회 브랜드 등록 패키지이고, DELUXE와 PREMIUM은 지속 성장형 브랜드 운영 플랜입니다.',
    ...
    'order-button': '패키지 주문',
    'foot-note': 'AMZBRAND는 아마존 셀러의 PPC 제어, 키워드 운영, 계정 관리를 돕습니다.',
    'foot-contact': '문의: snsherocom@gmail.com',
    'foot-copy': '&copy; 2026 BibleForAI AMZBRAND. All rights reserved.',
    'receipt-header': 'BIBLEFORAI - AMZBRAND 영수증',
    'receipt-date': '주문 날짜',
