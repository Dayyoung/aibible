...
const packageCatalog = [
  {
    id: 'survey-starter',
    name_en: 'Starter Survey Sprint',
    name_ko: '스타터 서베이 스프린트',
    desc_en: 'A fast market-validation package for teams that need a practical overseas survey plan, question outline, and launch checklist.',
    desc_ko: '해외 설문을 빠르게 시작하려는 팀을 위한 실무형 패키지로, 조사 계획·문항 초안·런칭 체크리스트를 제공합니다.',
    originalPrice: 716,
    price: 1432,
    featured: false,
    features_en: ['Survey blueprint', 'Bilingual intake form', 'Google Form handoff', 'PayPal receipt workflow'],
    features_ko: ['서베이 블루프린트', '한영 접수 폼', 'Google Form 인수인계', 'PayPal 영수증 워크플로우']
  },
  {
    id: 'survey-pro',
    name_en: 'Local Validation Package',
    name_ko: '로컬 검증 패키지',
    desc_en: 'For brands testing a new market: respondent screening, translation guidance, and practical launch insights from the survey.',
    desc_ko: '신규 시장을 검증하려는 브랜드를 위한 응답자 선별, 번역 가이드, 설문 기반 런칭 인사이트 제공 패키지입니다.',
    originalPrice: 1098,
    price: 2196,
    featured: true,
    features_en: ['Respondent screening', 'Translation guidance', 'Insight summary', 'Priority support'],
    features_ko: ['응답자 선별', '번역 가이드', '인사이트 요약', '우선 지원']
  },
  {
    id: 'survey-enterprise',
    name_en: 'Enterprise Research Suite',
    name_ko: '엔터프라이즈 리서치 슈트',
    desc_en: 'A full-service market research plan for teams that need strategy, field execution guidance, and post-survey decision support together.',
    desc_ko: '전략, 현장 실행 가이드, 설문 후 의사결정 지원까지 한 번에 해결해야 하는 팀을 위한 풀 서비스 패키지입니다.',
    originalPrice: 1432,
    price: 2864,
    featured: false,
    features_en: ['Full survey roadmap', 'Operational checklist', 'Bilingual coordination notes', 'Executive handoff summary'],
    features_ko: ['전체 서베이 로드맵', '운영 체크리스트', '한영 조율 메모', '임원용 요약본']
  }
];

const translations = {
  en: {
    'logo-subtitle': 'Global Survey Insights!',
    ...
    'hero-badge': 'Market Validation Ready',
    'hero-title': 'SurveyBoost — Global Market Survey & Local Validation',
    'hero-desc': 'Validate new markets with practical survey planning, respondent recruitment guidance, bilingual intake, and a clean PayPal-to-Google-Form workflow.',
    ...
    'section-packages-title': 'Global Survey Packages',
    'section-packages-sub': 'Prices are shown in USD with a 2x markup over the benchmark service rate.',
    ...
    'section-faq-sub': 'Short answers for founders, agencies, exporters, and product teams validating a new market.',
    'process-1-title': '1. Choose a package',
    'process-1-desc': 'Pick the scope that matches your research stage and project size.',
    ...
    'faq-a1': 'Email, company name, target market, and a short survey objective are enough to start.',
    'faq-q2': 'Is this for international teams?',
    ...
    'modal-market': 'Target Market / Country',
    'modal-market-placeholder': 'United States / Japan / UAE',
    'modal-goal': 'Survey Objective',
    'modal-goal-placeholder': 'Validate demand, language fit, and messaging before launch',
    'modal-qty': 'Quantity',
    'modal-total': 'Total Amount',
    'modal-test': 'Click price to payment checkout',
    'badge-paypal': 'PayPal Verified',
    'badge-ssl': 'SSL Secured',
    'footer-note': 'SurveyBoost provides practical business-entry planning with bilingual handoff, PayPal checkout, and Google Form receipt routing.'
  },
  ko: {
    ...
    'hero-title': 'SurveyBoost — 중국 법인 등록 & 시장 진출',
    ...
    'modal-company-placeholder': 'Acme Global Ltd.',
    'modal-market': '대상 시장 / 국가',
    'modal-market-placeholder': '미국 / 일본 / UAE',
    'modal-goal': '조사 목적',
    'modal-goal-placeholder': '수요, 언어 적합성, 메시지를 출시 전에 검증',
    'modal-qty': '수량',
    'modal-total': '총 결제금액',
    'modal-test': '가격 텍스트를 눌러 결제 진행',
    'badge-paypal': 'PayPal 인증',
    'badge-ssl': 'SSL 보안',
    'footer-note': 'SurveyBoost는 한중 이중 언어 인수인계, PayPal 결제, Google Form 영수증 라우팅을 포함한 실무형 진출 지원을 제공합니다.'
  }
};
...
function triggerTestCheckout() {
  ...
  if (!marketInput.value.trim()) marketInput.value = 'New York';
  if (!goalInput.value.trim()) goalInput.value = 'global market validation secure checkout test';
